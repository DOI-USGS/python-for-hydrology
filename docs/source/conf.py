...
# -*- coding: utf-8 -*-
#
# Python for Hydrology documentation build configuration file, created by
...
project = 'Python for Hydrology'
copyright = f"2022-{now.year}, USGS Python for Hydrology instructors"
author = 'USGS Python for Hydrology instructors'
...
version = '1.0'#mfsetup.__version__
# The full version, including alpha/beta/rc tags.
release = '1.0a'#mfsetup.__version__
...
exclude_patterns = ['_build', 'pleasant-example.rst',  "Thumbs.db", ".DS_Store", "**.ipynb_checkpoints"]
...
# settings for sphinxcontrib.collections
#collections = {
#   'notebooks': {
#      'driver': 'copy_folder',
#      'source': '../notebooks/',
#      #'target': 'my_data/',
#      'ignore': ['*.py', '.exe', '__pycache__', '*output'],
#      
#   }
#}
# copy notebooks to docs folder
dest_path = Path('notebooks')
...
copy_notebooks = [
    ...
    source_path / 'part0_python_intro/solutions/03_useful-std-library-modules-solutions.ipynb',
    source_path / 'part0_python_intro/solutions/04_files_and_strings.ipynb',
    source_path / 'part0_python_intro/05_numpy.ipynb',
...
shutil.copy('../../more_resources/glossary_of_jargon.md', '.')
shutil.copy('../../SOME_HELPFUL_LINKS.md', '.')
